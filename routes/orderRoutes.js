...
//         {
//           model: Product,
//           // Chú ý: Nếu bạn có alias cho Product trong Order thì phải dùng alias đó, vd: as: 'orderedProduct'
//           // Nếu không có alias, bỏ `as`.
//           include: [
//             {
//               model: DownloadFile,
//               as: 'downloadFile',
...
//         {
//           model: Product,
//           // Cũng lưu ý tương tự nếu dùng alias thì thêm as: 'orderedProduct'
//           include: [{ model: DownloadFile, as: 'downloadFile' }],
//         },
//       ],
//     });
